...
```sh
grep -rl 'ordercloud' ./ | xargs sed -i '' 's/ordercloud/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with ordercloud
...
Want to contribute? Ping us on `ordercloud` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/ordercloud.git
    cd ordercloud
    ```
...
- [ordercloud integration Documentation](https://docs.vuestorefront.io/ordercloud)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `ordercloud` channel on [our Discord](discord.vuestorefront.io).
